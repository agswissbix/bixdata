...
class Api_controller extends CI_Controller {
   ...
   public function crea_progetto($recordid_trattativa)
   {
    ...
    public function api_bexio_crea_ordine_progetto($recordid_trattativa)
   {
        $record_trattativa=$this->Sys_model->get_record('deal',$recordid_trattativa);
        $dealname=$record_trattativa['dealname'];
        ...
        $request_body=array();
        $request_body['title']="TEST-".$dealname."-ORDINE";
    ...
    public function api_bexio_crea_fattura_acconto_progetto($recordid_trattativa)
    {
         $record_trattativa=$this->Sys_model->get_record('deal',$recordid_trattativa);
         $dealname=$record_trattativa['dealname'];
